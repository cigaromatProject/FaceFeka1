            ...
            foreach($users as $user){
                if($user->profile->image){
                    if($user->profile->title){
                        ...
                        $output .=  '<li><a href="'.url('profile', $user->id).'"><div class="media"><img class="mr-3" src="'.asset($user->profile->image).'" width="50" height="50"><div class="media-body"><h6 class="mt-0">'.$user->name.'.</h6></div></div></a></li>';
                    }
